...
export default function IdeaForm({
    ...
    return (
        <div className="mx-auto max-w-2xl space-y-6">
            ...
            <form className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8" onSubmit={handleSubmit(onSubmit)}>
                <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select id="difficulty" {...register('difficulty')} className={fieldClass}>
